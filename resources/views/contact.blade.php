...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Contact Us, Our mailing address is: 152A Charlotte Street, Peterborough ON Phone: 705-742-3221, Great vision without great people is irrelevant. Let&amp;apos;s work together.">
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-align-left u-clearfix u-header u-section-row-container" id="sec-82e3"><div class="u-section-rows">
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="sec-ac2c">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-contain u-image-default u-image-1" src="images/Untitled-4.png" alt="" data-image-width="461" data-image-height="427">
                ...
                <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-1">
                    <div class="u-container-layout u-container-layout-1">
                      <h1 class="u-text u-text-grey-70 u-title u-text-1">Contact Us</h1>
                      <h2 class="u-subtitle u-text u-text-2">Our mailing address is: <br>152A Charlotte Street, <br>Peterborough ON <br>Phone: 705-742-3221 
                      </h2>
                      <div class="u-social-icons u-spacing-10 u-social-icons-1">
                ...
                <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2">
                      <h2 class="u-subtitle u-text u-text-default u-text-grey-75 u-text-3">Great vision without great people is irrelevant. Let's work together.</h2>
                    </div>
                  </div>
                      ...
                      <div class="u-form u-form-1">
                        <form action="https://forms.nicepagesrv.com/Form/Process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px" source="email" name="form-4">
                          ...
                          <div class="u-form-group u-form-submit">
                            <a href="#" class="u-btn u-btn-submit u-button-style u-palette-4-dark-1 u-btn-1">Submit</a>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                          </div>
                          <div class="u-form-send-message u-form-send-success"> Thank you! Your message has been sent. </div>
                          <div class="u-form-send-error u-form-send-message"> Unable to send your message. Please fix errors then try again. </div>
                          <input type="hidden" value="" name="recaptchaResponse">
                          <input type="hidden" name="formServices" value="9f0d1f2292b75cd0d886bdbcde3b112c">
                        </form>
                      </div>
                    </div>
                  </div>
