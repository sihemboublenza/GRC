    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="{{url('layout')}}"><img src="{{url('images/logo.svg')}}" alt="alternative"></a> 
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            <p class="mb-4">Fill out the form below to sign up for the service. Already signed up? Then just <a class="blue" href="{{url('log-in')}}">Log In</a></p>
