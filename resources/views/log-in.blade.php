...
<html lang="en">
    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <table>
            <center> <tr>
                <td>
                    <img src="{{url('images/client.png')}}" width="175" height="175">
                 </td>
                  <td>
                    <img src="{{url('images/admin.png')}}" width="175" height="175">
                 </td>
                  <td>
                    <img src="{{url('images/comer.png')}}" width="175" height="175">
                 </td>
             </tr></center>
        </table>
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            <p class="mb-4">You don't have a password? Then please <a class="blue" href="{{url('sign-up')}}">Sign Up</a></p>
