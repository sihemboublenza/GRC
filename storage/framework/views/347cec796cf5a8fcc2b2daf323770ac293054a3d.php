            ...
            <div class="container">
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav ms-auto navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<?php echo e(url('/')); ?>">Acceuil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('products')); ?>">Produits</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="<?php echo e(url('login')); ?>">Se connecter</a>
                    </span>
...
</html><?php /**PATH C:\laragon\www\GRC\resources\views/layout.blade.php ENDPATH**/ ?>