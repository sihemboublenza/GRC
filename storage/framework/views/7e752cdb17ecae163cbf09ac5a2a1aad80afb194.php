    ...
    <div class="col-lg-12">
      <div class="card mb-4">
        ...
        <div class="col-md-12 text-right">
          <a href="<?php echo e(url('/contact/create')); ?>" class="btn btn-success col-2">Ajouter</a>
        </div>
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/contact/list.blade.php ENDPATH**/ ?>