          ...
          <div class="col-xl-6 offset-xl-3">
            <div class="text-box mt-5 mb-5">
              ...
              <form action="<?php echo e(url('user/')); ?>" method="post">
                ...
                <input type="password" name="password" class="form-control" id="floatingInput4"><br>
                <label for="floatingInput5">Photo</label>
                <input type="file" name="photo" class="form-control" id="floatingInput5"><br>
                <br>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/user/create.blade.php ENDPATH**/ ?>