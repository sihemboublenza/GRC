    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="index.html"><img src="<?php echo e(url('images/logo.svg')); ?>" alt="alternative"></a> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        ...
                        <a class="btn-solid-reg mb-5" href="<?php echo e(url('layout')); ?>">Home</a>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
        </div> <!-- end of ex-basic-1 -->
...
<?php echo $__env->make('layout.public.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/article.blade.php ENDPATH**/ ?>