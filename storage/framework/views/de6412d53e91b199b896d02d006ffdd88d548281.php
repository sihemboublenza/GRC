    ...
    <div class="col-lg-12">
      <div class="card mb-4">
        ...
        <div class="col-md-12 text-right">
          <a href="<?php echo e(url('/produit/create')); ?>" class="btn btn-success col-2">Ajouter</a>
        </div>
        <div class="p-3 table-responsive">
          <table class="table" id="dataTable">
            ...
            <tr>                      
              ...
              <tr>
              <td><img src="../public/images/<?php echo e($item->photo); ?>"></td>
              ...
              <td><a href="<?php echo e(url('/produit/' . $item->id . '/edit/')); ?>" class="btn btn-sm btn-warning">Modifier</a></td>
              <td><form method="POST" action="<?php echo e(url('/produit' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/produit/list.blade.php ENDPATH**/ ?>