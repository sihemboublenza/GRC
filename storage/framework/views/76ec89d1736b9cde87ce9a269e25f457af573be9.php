        ...
        <div class="p-3 table-responsive">
          <table class="table" id="dataTable">
            ...
            <tr>                      
              ...
              <td><?php echo e($item->siteweb); ?></td>
              <td><a href="<?php echo e(url('/client/' . $item->id)); ?>" class="btn btn-sm btn-primary">Détails</a></td>
              <td><a href="<?php echo e(url('/client/' . $item->id . '/edit/')); ?>" class="btn btn-sm btn-warning">Modifier</a></td>
              <td><form method="POST" action="<?php echo e(url('/client' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/client/list.blade.php ENDPATH**/ ?>