    ...
    <body data-bs-spy="scroll" data-bs-target="#navbarExample">
        ...
        <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image" href="<?php echo e(url('layout')); ?>"><img src="<?php echo e(url('images/logo.svg')); ?>" alt="alternative"></a> 
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <ul class="navbar-nav ms-auto navbar-nav-scroll">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<?php echo e(url('layout')); ?>">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdown01">
                                <li><a class="dropdown-item" href="<?php echo e(url('article')); ?>">Article Details</a></li>
                                <li><div class="dropdown-divider"></div></li>
                                <li><a class="dropdown-item" href="<?php echo e(url('terms')); ?>">Terms Conditions</a></li>
                                <li><div class="dropdown-divider"></div></li>
                                <li><a class="dropdown-item" href="<?php echo e(url('privancy')); ?>">Privacy Policy</a></li>
                            </ul>
                        </li>
                    </ul>
                    <span class="nav-item">
                        <a class="btn-outline-sm" href="<?php echo e(url('log-in')); ?>">Log in</a>
                    </span>
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            <p class="mb-4">Fill out the form below to sign up for the service. Already signed up? Then just <a class="blue" href="<?php echo e(url('log-in')); ?>">Log In</a></p>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="footer-col second">
                            ...
                            <ul class="list-unstyled li-space-lg p-small">
                                <li>Important: <a href="<?php echo e(url('terms')); ?>">Terms & Conditions</a>, <a href="<?php echo e(url('privacy')); ?>">Privacy Policy</a></li>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/sign-up.blade.php ENDPATH**/ ?>