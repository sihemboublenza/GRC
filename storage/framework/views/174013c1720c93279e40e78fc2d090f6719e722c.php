    ...
    <div class="col-lg-12">
      <div class="card mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h4 class="m-0 font-weight-bold text-primary">Contacts de la société <u><?php echo e($client->societe); ?></u></h4>
        </div>
        <div class="p-3 table-responsive">
          <table class="table" id="dataTable">
            ...
            <tr>                      
              ...
              <td><a href="<?php echo e(url('/contact/' . $item->id)); ?>" class="btn btn-sm btn-primary">Détails</a></td>
              <td><a href="<?php echo e(url('/contact/' . $item->id . '/edit/')); ?>" class="btn btn-sm btn-warning">Modifier</a></td>
              <td><form method="POST" action="<?php echo e(url('/contact' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/client/mastercontact.blade.php ENDPATH**/ ?>