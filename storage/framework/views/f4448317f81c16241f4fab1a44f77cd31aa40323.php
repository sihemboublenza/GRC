    ...
    <div class="col-lg-12">
      <div class="card mb-4">
        ...
        <div class="col-md-12 text-right">
          <a href="<?php echo e(url('/opportunite/create')); ?>" class="btn btn-success col-2">Ajouter</a>
        </div>
        <div class="p-3 table-responsive">
          <table class="table" id="dataTable">
            ...
            <tbody>
            <tr>                      
	            <?php $__currentLoopData = $opportunites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
              <td><?php echo e($item->nom_opp); ?></td>
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/opportunite/list.blade.php ENDPATH**/ ?>