        ...
        <div class="mb-4 form-floating">
          <div class="col-xl-6 offset-xl-3">
            <div class="text-box mt-5 mb-5">
              ...
              <form action="<?php echo e(url('opportunite/produits')); ?>" method="post">
                <?php echo csrf_field(); ?>
                ...
                <input type="number" name="opportunite" hidden value="<?php echo e($opp->id); ?>"/>
                <br>
...
<?php echo $__env->make('layout.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GRC\resources\views/admin/opportunite/produits/create.blade.php ENDPATH**/ ?>